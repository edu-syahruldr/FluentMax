...
function Library:Notify(Options)
    ...
    if Icon then
        ...
        IconImage.Image = Library:GetIcon(Icon) or ""
        IconImage.ImageColor3 = Theme.Accent or Color3.fromRGB(96, 205, 255)
    ...
    TitleLabel.Size = UDim2.new(1, Icon and -26 or 0, 0, 20)
    TitleLabel.Font = Enum.Font.GothamBold
    TitleLabel.Text = Title
    TitleLabel.TextColor3 = Theme.Text or Color3.fromRGB(240, 240, 240)
    ...
    if Content and Content ~= "" then
        ...
        ContentLabel.TextColor3 = Theme.SubText or Color3.fromRGB(170, 170, 170)
    ...
    if SubContent and SubContent ~= "" then
        ...
        SubContentLabel.Size = UDim2.new(1, 0, 0, 0)
        ...
        SubContentLabel.TextTransparency = 0.3
    ...
    ProgressBar.BackgroundColor3 = Theme.Accent or Color3.fromRGB(96, 205, 255)
...
Components.Window =
    ...
    return function(Config)
        ...
        -- Set window position directly (no animation)
        local vp = Camera.ViewportSize
        ...
        function Window:Minimize()
            ...
            -- Toggle visibility directly (no animation)
            if Window.Minimized then
                ...
                local lastPos = Window.LastMinimizePos
                if lastPos then
                    Window.Root.Position = UDim2.new(0, lastPos.X, 0, lastPos.Y)
                    PosMotor:setGoal({
...
ElementsTable.Divider = (function()
    ...
    function Divider:New(Idx, Config)
        ...
        function DividerObject:SetTransparency(NewTransparency)
            local line = DividerFrame:FindFirstChild("Line")
            if line then
                line.BackgroundTransparency = NewTransparency
            end
        end
